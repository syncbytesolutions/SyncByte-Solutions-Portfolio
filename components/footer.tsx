...
export function Footer() {
  return (
    ...
    >
      ...
      {/* Background orb */}
      <div className="pointer-events-none absolute left-1/2 top-0 h-64 w-64 -translate-x-1/2 rounded-full"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 py-14 md:grid-cols-3">
          ...
          <div className="md:justify-self-end">
            <h3 className="font-heading text-sm font-semibold text-white">Connect</h3>
        ...
        <p className="py-6 text-center text-xs text-slate-600">
          © 2026{' '}
          <span className="text-violet-500">SyncByte Solutions (Pvt) Ltd.</span>
          {' '}All Rights Reserved.
        </p>
      </div>
    </footer>
